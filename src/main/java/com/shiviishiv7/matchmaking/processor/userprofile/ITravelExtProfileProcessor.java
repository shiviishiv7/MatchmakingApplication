...
public interface ITravelExtProfileProcessor {

    BaseVO add(TravelExtProfileVO vo) throws MatchmakingException;

    BaseVO update(TravelExtProfileVO vo) throws MatchmakingException;
